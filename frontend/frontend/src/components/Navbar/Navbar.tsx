import Services from '../washServices/Services'
...
const Navbar = ({showClients, showJobs, showServices}: Props) => {
  return (
    <div>
        <div className='bg-blue-500 flex items-center justify-between w-full h-12'>

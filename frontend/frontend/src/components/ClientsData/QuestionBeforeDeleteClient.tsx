...
const QuestionBeforeDeleteClient: React.FC<Props> = ({detail, update}) => {
    ...
    return (
        <div>
            <Button className="bg-blue-500 text-white font-medium text-md w-96" onPress={onOpen}>Eliminar Cliente</Button>
                        ...
                        <>
                            ...
                            <ModalBody className="flex flex-col items-center justify-center">
                                <p className="text-zinc-500"> 
                                    Al eliminar al cliente, se eliminaran los lavados, cobros y vehiculos del mismo. 
                                </p>
...
export default QuestionBeforeDeleteClient
